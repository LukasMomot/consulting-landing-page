...
export const FunnelLinkRaw = tw.a`
  text-lg my-2 lg:text-sm lg:mx-6 lg:my-0
  font-semibold tracking-wide transition duration-300
  pb-1 border-b-2 border-transparent hover:border-primary-500 hocus:text-primary-500
`;
...
export const NavToggle = tw.button`
  hidden z-20 focus:outline-none hocus:text-primary-500 transition duration-300
`;
...
export default ({ roundedHeaderButton = false, useLinks = true, logoLink, links, className, collapseBreakpointClass = "lg" }) => {
  /*
