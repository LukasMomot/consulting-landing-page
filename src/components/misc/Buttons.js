...
export const SecondaryButton = tw.button`px-8 py-3 font-bold rounded bg-gray-300 text-gray-700 hocus:bg-gray-500 hocus:text-gray-800 focus:shadow-outline focus:outline-none transition duration-300`;
